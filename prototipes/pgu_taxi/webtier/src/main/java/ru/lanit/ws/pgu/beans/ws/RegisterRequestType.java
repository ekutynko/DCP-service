...
@XmlType(name = "RegisterRequestType", namespace = "http://smev.gosuslugi.ru/rev120315", propOrder = {
    "message",
    "messageData"
})
public class RegisterRequestType {
    ...
    protected JAXBElement<ServiceMessageDataType> messageData;
     ...
     *     
     */
    public JAXBElement<ServiceMessageDataType> getMessageData() {
        return messageData;
    }
     ...
     *     
     */
    public void setMessageData(JAXBElement<ServiceMessageDataType> value) {
        this.messageData = ((JAXBElement<ServiceMessageDataType> ) value);
    }
