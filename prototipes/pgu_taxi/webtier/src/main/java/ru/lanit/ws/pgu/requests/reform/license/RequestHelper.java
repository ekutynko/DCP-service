...
public abstract class RequestHelper extends BaseRequestHelper {
    ...
    public LicenseRequestInfo getLicenseRequestInfo() {
        LicenseRequestInfo licenseRequestInfo = new LicenseRequestInfo();
        licenseRequestInfo.setLicenseNo(request.getLicenseNo());
        licenseRequestInfo.setBlankNo(getValue(request.getBlankNo()));
        licenseRequestInfo.setBlankSeries(getValue(request.getBlankSeries()));
        licenseRequestInfo.setReasons(toDictList(request.getReason()));
    ...
    public CarInfo getCarInfo() {
        ...
        if (carsInfoType != null) {
            CarInfoType carInfoType = carsInfoType.getCarInfo();
