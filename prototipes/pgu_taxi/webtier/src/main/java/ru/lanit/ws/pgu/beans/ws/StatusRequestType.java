 ...
 *         &lt;element name="MessageData" type="{http://smev.gosuslugi.ru/rev120315}StatusRequestMessageDataType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StatusRequestType", namespace = "http://smev.gosuslugi.ru/rev120315", propOrder = {
    "message",
    "messageData"
})
public class StatusRequestType {
    ...
    protected JAXBElement<StatusRequestMessageDataType> messageData;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link StatusRequestMessageDataType }{@code >}
     *     
     */
    public JAXBElement<StatusRequestMessageDataType> getMessageData() {
        return messageData;
    }
     ...
     *     
     */
    public void setMessageData(JAXBElement<StatusRequestMessageDataType> value) {
        this.messageData = ((JAXBElement<StatusRequestMessageDataType> ) value);
    }
