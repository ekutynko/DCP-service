 ...
 *         &lt;element name="MessageData" type="{http://smev.gosuslugi.ru/rev120315}ServiceCancelRequestMessageDataResponseType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CancelResponseType", namespace = "http://smev.gosuslugi.ru/rev120315", propOrder = {
    "message",
    "messageData"
})
public class CancelResponseType {
    ...
    protected JAXBElement<ServiceCancelRequestMessageDataResponseType> messageData;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ServiceCancelRequestMessageDataResponseType }{@code >}
     *     
     */
    public JAXBElement<ServiceCancelRequestMessageDataResponseType> getMessageData() {
        return messageData;
    }
     ...
     *     
     */
    public void setMessageData(JAXBElement<ServiceCancelRequestMessageDataResponseType> value) {
        this.messageData = ((JAXBElement<ServiceCancelRequestMessageDataResponseType> ) value);
    }
