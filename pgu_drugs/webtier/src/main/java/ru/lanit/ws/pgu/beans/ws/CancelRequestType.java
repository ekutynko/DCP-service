 ...
 *         &lt;element name="MessageData" type="{http://smev.gosuslugi.ru/rev120315}ServiceCancelRequestMessageDataType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CancelRequestType", namespace = "http://smev.gosuslugi.ru/rev120315", propOrder = {
    "message",
    "messageData"
})
public class CancelRequestType {
    ...
    protected JAXBElement<ServiceCancelRequestMessageDataType> messageData;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ServiceCancelRequestMessageDataType }{@code >}
     *     
     */
    public JAXBElement<ServiceCancelRequestMessageDataType> getMessageData() {
        return messageData;
    }
     ...
     *     
     */
    public void setMessageData(JAXBElement<ServiceCancelRequestMessageDataType> value) {
        this.messageData = ((JAXBElement<ServiceCancelRequestMessageDataType> ) value);
    }
