 ...
 *         &lt;element name="MessageData" type="{http://smev.gosuslugi.ru/rev120315}StatusResponseMessageDataType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StatusResponseType", namespace = "http://smev.gosuslugi.ru/rev120315", propOrder = {
    "message",
    "messageData"
})
public class StatusResponseType {
    ...
    protected JAXBElement<StatusResponseMessageDataType> messageData;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link StatusResponseMessageDataType }{@code >}
     *     
     */
    public JAXBElement<StatusResponseMessageDataType> getMessageData() {
        return messageData;
    }
     ...
     *     
     */
    public void setMessageData(JAXBElement<StatusResponseMessageDataType> value) {
        this.messageData = ((JAXBElement<StatusResponseMessageDataType> ) value);
    }
